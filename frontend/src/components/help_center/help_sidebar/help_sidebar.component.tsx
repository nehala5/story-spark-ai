...
const HelpSidebar: FC = () => {
  ...
  return (
    <>
      ...
      <nav className="hidden lg:block w-80 flex-shrink-0" aria-label="Help center sections">
              ...
              {HELP_SECTIONS.map((section) => {
                ...
                return (
                  <button
                    ...
                    className={`relative w-full text-left px-4 py-4 rounded-2xl transition-all duration-300 overflow-hidden border focus:outline-none ${
                      isActive
                        ? "border-blue-300 dark:border-blue-500/30 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 dark:from-blue-500/15 dark:to-indigo-500/15 shadow-sm"
